-- SYNAPSE X SCRIPT v2.1.0
-- Created by joker9292oo
-- GitHub: https://github.com/joker9292oo/B
-- Last Updated: 2025-07-02

local function LoadSynapseX()
    ...
    local function saveSettings()
        if not pcall(function() return isfolder end) then return end
...
-- Return the loader function for external use
return LoadSynapseX
